...
const services = [
  {
    ...
    description: "Full-stack web applications built with React, Django, and modern technologies",
    features: ["React & TypeScript", "Django REST Framework", "PostgreSQL Database", "Cloud Deployment"],
    price: "From ₹50,000",
    color: "cyan"
  },
  {
  ...
  },
  {
    ...
    description: "Robust, scalable APIs and integrations for seamless data flow",
  ...
  },
  {
    ...
    features: ["Speed Optimization", "SEO Enhancement", "Core Web Vitals", "Mobile Optimization"],
    price: "From ₹20,000",
    color: "violet"
  },
  {
    ...
    features: ["Mobile-First Approach", "Cross-Browser Testing", "Progressive Web Apps", "Accessibility"],
    price: "From ₹15,000",
    color: "cyan"
  },
  {
    ...
    features: ["Technical SEO", "Google Analytics", "Performance Monitoring", "Growth Analysis"],
    price: "From ₹10,000",
    color: "violet"
  }
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional web development services including React development, UI/UX design, API development, and performance optimization. Get a quote today." />
      </Helmet>
            ...
            >
              {pricingTiers.map((tier, index) => (
                ...
                >
                  ...
                  <Card className={`p-8 h-full ${tier.popular ? 'border-secondary/40 shadow-glow-violet' : 'glass border-border/20'} transition-all duration-300`}>
